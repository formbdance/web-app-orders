...
export const AddProduct = () => {
  ...
  return (
    <section>
      <h4 className="font-semibold text-lg mb-3">Добавление продукта</h4>
      <form
        onSubmit={(e) => handleSubmit(e)}
        className="px-6 mt-2 flex flex-col gap-4"
      >
        <button
          className="relative overflow-hidden align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] flex items-center gap-3"
          type="button"
        >
          <svg
          ...
          <span className="text-center font-semibold w-full">Upload Image</span>
          <input
            type="file"
            name="image"
            className="left-0 absolute w-full h-full opacity-0"
          />
        </button>
